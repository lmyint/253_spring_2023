...
Before class on Monday, January 23, you should follow these instructions to set up the software that we'll be using throughout the semester. **Even if you've already downloaded both R and RStudio, you'll want to re-download to make sure that you have the most current versions.**
...
- **FIRST:** Download R [here](http://lib.stat.cmu.edu/R/CRAN/).
    ...
    - As of January 17, 2023, the latest version of R is 4.2.2.
- **SECOND:** Download RStudio [here](https://rstudio.com/products/rstudio/download/#download).
    ...
    - As of January 17, 2023, the latest version of RStudio is 2022.12.0+353.
