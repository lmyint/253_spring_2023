...
Slides from today are available [here](https://docs.google.com/presentation/d/1oscnbn1cwRIlr7HIFtKhJ6BAbaBVAy7xNPxzgBYJ8mY/edit?usp=sharing).

<!-- Include an exercise or PollEv question on: how many models are fit in LASSO? (# of lambdas tried) (To prep students for computational time in portfolio) -->
...
**You can download a template RMarkdown file to start from [here](template_rmds/06-lasso.Rmd).**
